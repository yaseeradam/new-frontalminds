...
// Dribbble Icon
export const DribbbleIcon = ({ className = "w-5 h-5" }: { className?: string }) => (
    <svg className={className} viewBox="0 0 24 24" fill="currentColor">
...
export const SocialLink = ({ href, icon, label, className = '', size = 'md' }: SocialLinkProps) => {
    const sizeClasses = {
    ...
    return (
        <a
            ...
            className={`group relative ${sizeClasses[size]} border border-white/10 flex items-center justify-center text-[#64748b] hover:border-[#22c55e]/50 hover:text-[#22c55e] transition-all duration-300 overflow-hidden ${className}`}
        >
